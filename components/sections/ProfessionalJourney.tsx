				...
				<div className="container">
					<div className="row align-items-end">
						<div className="col-lg-7 me-auto">
							<h3 className="ds-3 mt-3 mb-3 text-primary-1">Professional Journey</h3>
					...
					<div className="row mt-6">
									...
									<div className="resume-card-item px-4 py-3 mt-5">
										<div className="d-flex align-items-end">
											<div>
												...
												<p className="text-300 mb-0">University of Colombo, Sri Lanka</p>
											</div>
											<h3 className="text-linear-1 ms-auto fw-semibold">GPA - 2.7<span className="fs-4 fw-bold">/4</span></h3>
										</div>
									</div>
								</div>
							</div>
						...
						<div className="col-lg-6 col-12">
							<div className="resume-card p-lg-6 p-4 h-100">
								...
								<div className="resume-card-body">
									<div className="resume-card-item px-4 py-3 mt-5">
										<p className="fw-extra-bold text-linear-1 mb-2">2024 Dec - Present</p>
										<h5>Senior Consultant Developer</h5>
										<p className="text-300 mb-0">J & S International Ltd</p>
									</div>
									<div className="resume-card-item px-4 py-3 mt-5">
										<p className="fw-extra-bold text-linear-1 mb-2">2022 July - 2024 Dec</p>
										<h5>Senior Application Consultant</h5>
										<p className="text-300 mb-0">U3 Infotech Pte Ltd</p>
									</div>
									<div className="resume-card-item px-4 py-3 mt-5">
										<p className="fw-extra-bold text-linear-1 mb-2">2020 Mar - 2022 July</p>
										<h5>Software Engineer</h5>
										<p className="text-300 mb-0">Intervest Software Technologies Pvt Ltd</p>
									</div>
									<div className="resume-card-item px-4 py-3 mt-4">
										<p className="fw-extra-bold text-linear-1 mb-2">2018 May - 2020 Feb</p>
										<h5>Software Engineer</h5>
										<p className="text-300 mb-0">Esshva Techq Pvt Ltd</p>
									</div>
								</div>
							</div>
						</div>
